...
# import child python files
from utilities.util_no_dependencies import * # general utilities
from utilities.util_pull_query_results import * # to process query results
from utilities.util_find_categories import * # to link terms
from utilities.util_is_category_instance import * # to evaluate terms' category relationships
...
def load_html(myURL,sourceToLoad="Unknown"):
	...
	if len(urlContent_raw) < 1:
		print("Warning: there is no content to pull from temp_preprocessing_text.txt!")
	# parse the HTML 
	urlContent_ready = []
