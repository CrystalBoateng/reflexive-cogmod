#The reason this file is stored in the root directory is so that it can be written-to/read, without starting a new runtime. This requires executing it within an execution. The function which performs that task is refreshKnownTerms().
